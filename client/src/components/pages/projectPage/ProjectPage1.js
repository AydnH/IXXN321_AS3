      ...
      <div className="pp-cont">
        ...
        <div className="pp-section">
          <div className="pp-flexcontainer">
            ...
            <p className="pp-project-synopsis">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim
              pretium sit id scelerisque auctor tellus sit vitae nibh. Aenean
        ...
        <div className="pp-section">
          <div className="pp-flexcontainer2">
            <img className="pp-sml-img" src={landscape} alt="placeholder" />
            <p className="pp-project-synopsis3">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim
              pretium sit id scelerisque auctor tellus sit vitae nibh. Aenean
              pellentesque imperdiet morbi vitae varius sed pellentesque aliquet
              ultricies. Dignissim blandit ultrices vehicula convallis. Congue
              massa dui eu porttitor faucibus mi neque, venenatis. Congue massa
              dui eu. Congue massa dui eu porttitor faucibus mi neque,
              venenatis. Congue massa dui eu. Dignissim blandit.
            </p>
          </div>
        </div>
