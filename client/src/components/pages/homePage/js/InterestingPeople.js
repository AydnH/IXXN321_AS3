  ...
  return (
    <div id="InterestingPeopleCont">
      ...
      <div id="IntPeopleCont">
        <div
          className="personCont personCont1"
          style={{ backgroundImage: student1 }}
        >
          <div className="hoverInfo">
            <h1>Firstname Lastname</h1>
            <p>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Enim
              pretium sit id scelerisque auctor tellus sit vitae nibh.
            </p>
          </div>
        </div>

        <div
          className="personCont personCont2"
          style={{ backgroundImage: student2 }}
        >
          <div className="hoverInfo">
            <h1>Firstname Lastname</h1>
            <p>
        ...
        <div
          className="personCont personCont3"
          style={{ backgroundImage: student3 }}
        >
          <div className="hoverInfo">
            <h1>Firstname Lastname</h1>
            <p>
